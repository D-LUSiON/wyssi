...
<html>
    <head>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="{get_path asset="css/bootstrap.min.css"}" rel='stylesheet' type='text/css' />
        <!-- Custom CSS -->
        <link href="{get_path asset="css/style.css"}" rel='stylesheet' type='text/css' />
        <!-- Graph CSS -->
        <link href="{get_path asset="css/font-awesome.css"}" rel="stylesheet"> 
        <!-- jQuery -->
        <!-- lined-icons -->
        <link rel="stylesheet" href="{get_path asset="css/icon-font.min.css"}" type='text/css' />
        <!-- //lined-icons -->
        <!-- chart -->
        <script src="{get_path asset="js/Chart.js"}"></script>
        <!-- //chart -->
        <!--animate-->
        <link href="{get_path asset="css/animate.css"}" rel="stylesheet" type="text/css" media="all">
        <script src="{get_path asset="js/wow.min.js"}"></script>
        <script>
            new WOW().init();
        </script>
        <!--//end-animate-->
        ...
        <!---//webfonts---> 
        <!-- Meters graphs -->
        <script src="{get_path asset="js/jquery-1.10.2.min.js"}"></script>
    ...
    <body class="sticky-header left-side-collapsed"  onload="initMap()">
                            ...
                            <div class="profile_details_left">
                                <ul class="nofitications-dropdown">
                                    ...
                                    <li class="login_box" id="loginContainer">
                                        ...
                                        <!-- search-scripts -->
                                        <script src="{get_path asset="js/classie.js"}"></script>
                                        <script src="{get_path asset="js/uisearch.js"}"></script>
                                        <script>
                                            {literal}
                        ...
                        <div class="switches">
                            <div class="col-4">
                                ...
                                <div class="col-md-4 switch-right">
                                    ...
                                    <div class="sparkline">
                                        <!--graph-->
                                        <link rel="stylesheet" href="{get_path asset="css/graph.css"}">
                                        <script src="{get_path asset="js/jquery.flot.min.js"}"></script>
                                        <!--//graph-->
                                        <script>
                                            {literal}
                                ...
                                <div class="activity_box activity_box1">
                                    ...
                                    <form>
                                        <input type="text" value="Enter your text" onfocus="this.value = '';" onblur="if (this.value == '')
                                                            {literal}{this.value = 'Enter your text';}{/literal}" required="">
        ...
        <script src="{get_path asset="js/jquery.nicescroll.js"}"></script>
        <script src="{get_path asset="js/scripts.js"}"></script>
        <!-- Bootstrap Core JavaScript -->
        <script src="{get_path asset="js/bootstrap.min.js"}"></script>
    </body>
</html>